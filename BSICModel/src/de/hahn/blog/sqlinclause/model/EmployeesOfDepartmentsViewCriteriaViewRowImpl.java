...
// ---------------------------------------------------------------------
public class EmployeesOfDepartmentsViewCriteriaViewRowImpl extends ViewRowImpl {
    ...
    public static final int DEPARTMENTIDSTR = AttributesEnum.DepartmentIdStr.index();
     ...
     */
    public EmployeesOfDepartmentsViewCriteriaViewRowImpl() {
    }
    ...
    /**
     * Gets the attribute value for the calculated attribute DepartmentIdStr.
     * @return the DepartmentIdStr
     */
    public String getDepartmentIdStr() {
        return (String) getAttributeInternal(DEPARTMENTIDSTR);
    }
